...
def  bisection(f, x0, x1, tol,grafica):
    iterador = 0
    y_vals = []
    x2=0
    while x1-x0>=tol and iterador < limite:
        x2=((x0+x1)/2)
        y_vals.append(x2)
        if f(x2)==0:
            resultado = []
...
if __name__ == "__main__": 
    ...
    for tol in tols:  
        retorno = bisection(uno, 0, 2,tol,"bisection1")
        i+=1
    ...
    for tol in tols:  
        retorno = bisection(dos, -1, 2,tol,"bisection2")
        iteraciones = retorno[0]
        raiz = retorno[1]
    ...
    for tol in tols:  
        retorno = bisection(tres, -1, 0.7,tol,"bisection3")
        iteraciones = retorno[0]
        raiz = retorno[1]
        print(f'En {iteraciones} iteraciones y tolerancia de {tol} se obtuvieron las raices {Decimal(raiz)}')
    ...
    for tol in tols:  
        retorno = bisection(cuatro, 10, 16,tol,"bisection4")
        iteraciones = retorno[0]
        raiz = retorno[1]
        print(f'En {iteraciones} iteraciones y tolerancia de {tol} se obtuvieron las raices {Decimal(raiz)}')
    ...
    for tol in tols:  
        retorno = bisection(cinco, 1, 4,tol,"bisection5")
        iteraciones = retorno[0]
        raiz = retorno[1]
        print(f'En {iteraciones} iteraciones y tolerancia de {tol} se obtuvieron las raices {Decimal(raiz)}')
